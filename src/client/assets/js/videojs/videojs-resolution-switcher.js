     ...
     */
       ...
       */
            ...
            function initResolutionForYt (player) {
                ...
                player.tech_.ytPlayer.addEventListener(`onPlaybackQualityChange`, (event) => {
                ...
                player.one(`play`, function () {
                    ...
                    const chosen = { label: `auto`, res: 0, sources: player.groupedSrc.label.auto };
